...
public class Chess : MonoBehaviour
{
    ...
    public void Activate()
    {
        ...
        controller = GameObject.FindGameObjectWithTag("Game");
    ...
    public void PawnMovePlate(int x, int y)
    {
        ...
        if (sc.PositionOnBoard(x, y))
        {
            ...
            if (sc.PositionOnBoard(x + 1, y) && sc.GetPosition(x + 1, y) != null && sc.GetPosition(x + 1, y).GetComponent<Chess>().player != player)
            {
    ...
    public void MovePlateSpawn(int matrixX, int matrixY)
    {
        ...
        MoveCircle mpScript = mp.GetComponent<MoveCircle>();
